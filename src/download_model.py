...
# --- KONFIGURACJA ---
# Wklej tutaj ID swojego pliku z Google Drive
...
def download_model():
    ...
    # URL do pobierania z gdown
    url = f'https://drive.google.com/uc?id={FILE_ID}'
    
    try:
        # 1. POBIERANIE NA DYSK (oszczędza RAM)
        ...
        # 2. ROZPAKOWYWANIE Z DYSKU (oszczędza RAM)
        # Otwieramy plik z dysku, a nie z pamięci
